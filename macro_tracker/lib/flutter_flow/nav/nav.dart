...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/goal',
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Goal') : GoalWidget(),
        ),
        FFRoute(
          name: 'EditProfile',
          path: '/editProfile',
        ...
        FFRoute(
          ...
          path: '/diet',
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'Diet') : DietWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'AddCustomFood',
          path: '/addCustomFood',
          builder: (context, params) => AddCustomFoodWidget(),
        ),
        FFRoute(
          name: 'AddBarcodeFood',
          path: '/addBarcodeFood',
          builder: (context, params) => AddBarcodeFoodWidget(
            scannedBarcode: params.getParam('scannedBarcode', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'editDiaryFood',
